...
${OBJECTDIR}/csv.o: csv.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/csv.o csv.cpp
...
${TESTDIR}/tests/csv_read_write_test.o: tests/csv_read_write_test.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/csv_read_write_test.o tests/csv_read_write_test.cpp
...
${OBJECTDIR}/csv_nomain.o: ${OBJECTDIR}/csv.o csv.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/csv_nomain.o csv.cpp;\
	else  \
